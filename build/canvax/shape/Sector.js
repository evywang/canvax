...
KISSY.add('canvax/shape/Sector', function (S, Shape, myMath, Base) {
    var Sector = function (opt) {
        ...
        self._context = {
            ...
            r: opt.context.r || 0,
            //{number},  // 必须，外圆半径
            startAngle: myMath.degreeTo360(opt.context.startAngle) || 0,
            //{number},  // 必须，起始角度[0, 360)
            endAngle: myMath.degreeTo360(opt.context.endAngle) || 0,
 ...
 ? // 形内半径[0,r)
            ...
            */
            ...
            if (!isCircle) {
                ...
                pointList.push([
                    myMath.cos(startAngle) * r0,
                    myMath.sin(startAngle) * r0
                ]);
                pointList.push([
                    myMath.cos(startAngle) * r,
                    myMath.sin(startAngle) * r
                ]);
                pointList.push([
                    myMath.cos(endAngle) * r,
                    myMath.sin(endAngle) * r
                ]);
                pointList.push([
                    myMath.cos(endAngle) * r0,
