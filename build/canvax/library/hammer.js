 ...
 */
   ...
   */
            onTouch: function onTouch(element, eventType, handler) {
                ...
                this.bindDom(element, Hammer.EVENT_TYPES[eventType], function bindDomOnTouch(ev) {
                    ...
                    else // mousebutton must be down or a touch event
                    ...
                    else // mouse isn't pressed
                    if (sourceEventType.match(/mouse/) && !ev.which) {
                        enable_detect = false;
                    ...
                    if (enable_detect) {
                        ...
                        else // no touches, force the end event
                        if (!count_touches) {
   ...
   */
            determineEventTypes: function determineEventTypes() {
                ...
                else // on Android, iOS, blackberry, windows mobile we dont want any mouseevents
   ...
   */
            extendEventData: function extendEventData(ev) {
                ...
                var delta_time = ev.timeStamp - startEv.timeStamp, delta_x = ev.center.pageX - startEv.center.pageX, delta_y = ev.center.pageY - startEv.center.pageY, velocity = Hammer.utils.getVelocity(delta_time, delta_x, delta_y), interimAngle, interimDirection;    // end events (e.g. dragend) don't have useful values for interimDirection & interimAngle
        ...
        Hammer.gestures.Hold = {
            ...
            handler: function holdGesture(ev, inst) {
                ...
                case Hammer.EVENT_START:
                    ...
                    break;    // when you move or end we clear the timer
        ...
        Hammer.gestures.Tap = {
            ...
            handler: function tapGesture(ev, inst) {
                if (ev.eventType == Hammer.EVENT_END && ev.srcEvent.type != 'touchcancel') {
                    ...
                    var prev = Hammer.detection.previous, did_doubletap = false;    // when the touchtime is higher then the max touch time
 ...
 */
        ...
        else // check for `exports` after `define` in case a build optimizer adds an `exports` object
        ...
        /*标注出来目前所有Hammer可以用的事件*/
        Hammer.EventsTypes = 'hold tap doubletap drag dragstart dragend dragup dragdown dragleft dragright swipe swipeup swipedown swipeleft swiperight transform transformstart transformend rotate pinch pinchin pinchout touch release';
        return Hammer;
    }(window);
});