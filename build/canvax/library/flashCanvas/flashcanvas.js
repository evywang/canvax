 ...
 */
KISSY.add('canvax/library/flashCanvas/flashcanvas', function (S) {
    window.ActiveXObject && !window.CanvasRenderingContext2D && function (l, k, q) {
        ...
        A.prototype = {
            ...
            restore: function () {
                var a = this.I;
                if (a.length)
                    a = a.pop(), this.globalAlpha = a[0], this.globalCompositeOperation = a[1], this.strokeStyle = a[2], this.fillStyle = a[3], this.lineWidth = a[4], this.lineCap = a[5], this.lineJoin = a[6], this.miterLimit = a[7], this.shadowOffsetX = a[8], this.shadowOffsetY = a[9], this.shadowBlur = a[10], this.shadowColor = a[11], this.font = a[12], this.textAlign = a[13], this.textBaseline = a[14];
                this.a.push('C');
            },
            scale: function (a, b) {
                this.a.push('D', a, b);
            ...
            createPattern: function (a, b) {
                ...
                if (c)
                    if (c = c.toLowerCase(), c === 'img')
                        d = a.getAttribute('src', 2);
                    else if (c === r)
                        e = this.C(a), f = a !== this.canvas;
                    else if (c === 'video')
                        return;
                    else
                        i(17);
            ...
            drawImage: function (a, b, c, d, e, f, h, ja, l) {
                ...
                if (g)
                    if (g = g.toLowerCase(), g === 'img')
                        k = a.getAttribute('src', 2);
                    else if (g === r)
                        j = this.C(a), m = a !== this.canvas;
                    else if (g === 'video')
                        return;
                    else
                        i(17);
                ...
                this.h(0);
                if (n === 3)
                    this.a.push('u', n, j, b, c);
                else if (n === 5)
                    this.a.push('u', n, j, b, c, d, e);
                else if (n === 9)
                    (d === 0 || e === 0) && i(1), this.a.push('u', n, j, b, c, d, e, f, h, ja, l);
                else
                    return;
            ...
            putImageData: function (a, b, c, d, e, f, h) {
                ...
                var g = arguments.length, j = a.width, k = a.height, l = a.data;
            ...
            loadImage: function (a, b, c) {
                ...
                if (d)
                    d.toLowerCase() === 'img' && (e = a.getAttribute('src', 2));
                else if (a.src)
                    e = a.src;
                if (e && u[f][e] === q) {
                    d = this.k(e);
            ...
            h: function (a) {
                var b = this.a, c;
                if (this.m !== this.globalAlpha)
                    b.push('I', this.m = this.globalAlpha);
                if (this.n !== this.globalCompositeOperation)
                    b.push('J', this.n = this.globalCompositeOperation);
                if (this.u !== this.shadowOffsetX)
                    b.push('T', this.u = this.shadowOffsetX);
                if (this.v !== this.shadowOffsetY)
                    b.push('U', this.v = this.shadowOffsetY);
                if (this.s !== this.shadowBlur)
                    b.push('V', this.s = this.shadowBlur);
                if (this.t !== this.shadowColor)
                    c = this.t = this.shadowColor, ('' + c).indexOf('%') > 0 && this.i.push(b.length + 1), b.push('W', c);
                if (a & 1 && this.l !== this.fillStyle)
                    c = this.l = this.fillStyle, typeof c === 'string' ? (c.indexOf('%') > 0 && this.i.push(b.length + 1), b.push('L', c)) : (c instanceof o || c instanceof x) && b.push('L', c.id);
                if (a & 2 && this.w !== this.strokeStyle)
                    c = this.w = this.strokeStyle, typeof c === 'string' ? (c.indexOf('%') > 0 && this.i.push(b.length + 1), b.push('K', c)) : (c instanceof o || c instanceof x) && b.push('K', c.id);
                if (a & 4) {
                    if (this.q !== this.lineWidth)
                        b.push('P', this.q = this.lineWidth);
                    if (this.o !== this.lineCap)
                        b.push('Q', this.o = this.lineCap);
                    if (this.p !== this.lineJoin)
                        b.push('R', this.p = this.lineJoin);
                    if (this.r !== this.miterLimit)
                        b.push('S', this.r = this.miterLimit);
                }
                if (a & 8) {
                    if (this.j !== this.font)
                        a = z[this.e].offsetHeight, this.g.push(b.length + 2), b.push('o', a, this.j = this.font);
                    if (this.A !== this.textAlign)
                        b.push('p', this.A = this.textAlign);
                    if (this.B !== this.textBaseline)
                        b.push('q', this.B = this.textBaseline);
                    if (this.D !== this.canvas.currentStyle.direction)
                        b.push('1', this.D = this.canvas.currentStyle.direction);
                }
            },
            c: function () {
                var a = this;
            ...
            f: function (a) {
                ...
                if (h.length) {
                    ...
                    this.g = [];
                    if (a)
                        g.flashvars = 'c=' + b, g.width = g.clientWidth + this.H, this.H ^= -2;
                    else
                        return g.CallFunction('<invoke name="executeCommand" returntype="javascript"><arguments><string>' + b + '</string></arguments></invoke>');
                }
            },
            K: function (a, b) {
                this.f();
            ...
            C: function (a) {
                ...
                if (b !== this.e && (a = m[b].getContext('2d'), !a.d))
                    b = ++ba[b], c += ':' + b, a.a.push('3', b), a.b || a.c(), a.d = 1;
                return c;
            },
            k: function (a) {
        ...
        var ga = {
                ...
                initElement: function (a) {
                    ...
                    if (e(a))
                        ...
                        var f = setInterval(function () {
                                if (e(a))
                                    clearInterval(f), d.movie = t;
                            }, 0);
                    if (k.compatMode === 'BackCompat' || !l.XMLHttpRequest)
                        z[b].style.overflow = 'hidden';
                    var h = new A(a, d);
                ...
                unlock: function (a, b, c) {
                    ...
                    if (b === q) {
                        ...
                        e = f[0], c = f[1 + c], delete v[a][b], typeof c === 'function' && c.call(e);
                }
            };
        k.createElement(r);
